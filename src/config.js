...
const DEFAULTS = {
  ...
  linkMaxUrls: 2,
  linkPageTimeoutMs: 2500,
  linkPageCacheMs: 10 * 60 * 1000,
  linkMaxPageBytes: 2 * 1024 * 1024,
  linkMaxPageChars: 6000,
  linkMaxContextChars: 4000,
  ...
  searchMaxContextChars: 4000,
  searchSetupTimeoutMs: 180000,
  preSearchMinTokens: 5,
  preSearchMaxQueries: 5,
  preSearchMaxResults: 10,
  preSearchMinConfidence: 0.65,
  preSearchMinSimilarity: 0.72,
  preSearchCacheMs: 5 * 60 * 1000,
  preSearchMaxEntries: 50,
  preSearchMaxDraftChars: 1200,
  sourceSummaryCacheMs: 30 * 60 * 1000,
  sourceSummaryMaxEntries: 120,
  toolsEnabled: true,
  toolTimeoutMs: 1800,
...
export function loadConfig(env = process.env, cwd = process.cwd()) {
  ...
  return {
    ...
    defaultSystemPrompt: env.NAOW_DEFAULT_SYSTEM_PROMPT || DEFAULT_SYSTEM_PROMPT,
    ...
    linkMaxUrls: parsePositiveInt(env.NAOW_LINK_MAX_URLS, DEFAULTS.linkMaxUrls, 'NAOW_LINK_MAX_URLS'),
    linkPageTimeoutMs: parsePositiveInt(env.NAOW_LINK_PAGE_TIMEOUT_MS, DEFAULTS.linkPageTimeoutMs, 'NAOW_LINK_PAGE_TIMEOUT_MS'),
    linkPageCacheMs: parsePositiveInt(env.NAOW_LINK_PAGE_CACHE_MS, DEFAULTS.linkPageCacheMs, 'NAOW_LINK_PAGE_CACHE_MS'),
    linkMaxPageBytes: parsePositiveInt(env.NAOW_LINK_MAX_PAGE_BYTES, DEFAULTS.linkMaxPageBytes, 'NAOW_LINK_MAX_PAGE_BYTES'),
    linkMaxPageChars: parsePositiveInt(env.NAOW_LINK_MAX_PAGE_CHARS, DEFAULTS.linkMaxPageChars, 'NAOW_LINK_MAX_PAGE_CHARS'),
    linkMaxContextChars: parsePositiveInt(env.NAOW_LINK_MAX_CONTEXT_CHARS, DEFAULTS.linkMaxContextChars, 'NAOW_LINK_MAX_CONTEXT_CHARS'),
    ...
    preSearchModel: env.NAOW_PRESEARCH_MODEL || DEFAULTS.preSearchModel,
    preSearchMinTokens: parsePositiveInt(env.NAOW_PRESEARCH_MIN_TOKENS, DEFAULTS.preSearchMinTokens, 'NAOW_PRESEARCH_MIN_TOKENS'),
    preSearchMaxQueries: parsePositiveInt(env.NAOW_PRESEARCH_MAX_QUERIES, DEFAULTS.preSearchMaxQueries, 'NAOW_PRESEARCH_MAX_QUERIES'),
    preSearchMaxResults: parsePositiveInt(env.NAOW_PRESEARCH_MAX_RESULTS, DEFAULTS.preSearchMaxResults, 'NAOW_PRESEARCH_MAX_RESULTS'),
    preSearchMinConfidence: Number(env.NAOW_PRESEARCH_MIN_CONFIDENCE || DEFAULTS.preSearchMinConfidence),
    preSearchMinSimilarity: Number(env.NAOW_PRESEARCH_MIN_SIMILARITY || DEFAULTS.preSearchMinSimilarity),
    preSearchCacheMs: parsePositiveInt(env.NAOW_PRESEARCH_CACHE_MS, DEFAULTS.preSearchCacheMs, 'NAOW_PRESEARCH_CACHE_MS'),
    preSearchMaxEntries: parsePositiveInt(env.NAOW_PRESEARCH_MAX_ENTRIES, DEFAULTS.preSearchMaxEntries, 'NAOW_PRESEARCH_MAX_ENTRIES'),
    preSearchMaxDraftChars: parsePositiveInt(env.NAOW_PRESEARCH_MAX_DRAFT_CHARS, DEFAULTS.preSearchMaxDraftChars, 'NAOW_PRESEARCH_MAX_DRAFT_CHARS'),
    sourceSummaryCacheMs: parsePositiveInt(env.NAOW_SOURCE_SUMMARY_CACHE_MS, DEFAULTS.sourceSummaryCacheMs, 'NAOW_SOURCE_SUMMARY_CACHE_MS'),
    sourceSummaryMaxEntries: parsePositiveInt(env.NAOW_SOURCE_SUMMARY_MAX_ENTRIES, DEFAULTS.sourceSummaryMaxEntries, 'NAOW_SOURCE_SUMMARY_MAX_ENTRIES'),
    ...
    deepResearchModel:
      env.NAOW_DEEP_RESEARCH_MODEL || null,
